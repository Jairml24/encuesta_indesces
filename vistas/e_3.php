...
<div id='e-3' style='display: flex;justify-content:center;margin-top: 30px'>
<form id='frm3'  class='w-100 ml-4 mr-4'>
        <h5 style='color:#3B61A8'>2. ÁREAS DE INTERÉS PARA EL TURISMO</h5>
        <label>Para seleccionar áreas de interés para el turismo en el ámbito de Paracas, elegir la variable más importante (derecha o izquierda) y marcar el círculo con el valor de cuán importante es respecto a la otra variable.</label>
        <label><strong>¿Cuál es la variable más importante para identificar áreas de interés para el turismo?</strong> <button class='ml-5 btn-sm btn-danger' id='s-2'>Saltar esta sección</button></label>

<!-- LINEA 1 -->
<div class='row mt-4' style='background:#eee;border-radius:10px;margin-bottom:10px'>
            <label class='col-3' for="">Presencia de áreas históricas y arqueológicas  </label>
            ...
            <label class='col-3 text-right' for="">Presencia de áreas de importancia natural </label>        
        </div>
...
<!-- LINEA 2 -->
        <div class='row' style='background:#eee;border-radius:10px;margin-bottom:10px'>
            ...
            <label id='<?php echo $i ?>' class='col-3 text-right' for="">Presencia de áreas de importancia recreativa </label>        
        </div>
...
<!-- LINEA 3 -->
        <div class='row' style='background:#eee;border-radius:10px;margin-bottom:10px'>
            ...
            <label id='<?php echo $i ?>' class='col-3 text-right' for="">Distancia a vías de acceso</label>        
        </div>
...
<!-- LINEA 4 -->        
        <div class='row' style='background:#eee;border-radius:10px;margin-bottom:10px'>
            ...
            <label id='<?php echo $i ?>' class='col-3 text-right' for="">Distancia a hoteles</label>        
        </div>

<!-- LINEA 5 -->
        <div class='row' style='background:#eee;border-radius:10px;margin-bottom:10px'>
            <label class='col-3' for="">Presencia de áreas naturales (ejemplo: Islas Ballestas y humedales) </label>
            <div class='col-6 d-flex justify-content-between ' >
                <?php
                $c=-9; 
                    for($i=0;$i<9;$i++)
...
<!-- LINEA 8 -->
        <div class='row' style='background:#eee;border-radius:10px;margin-bottom:10px'>
            <label class='col-3' for="">Presencia de áreas recreativas (ejemplo: zonas de kitesurfing, areneros y playas) </label>
            <div class='col-6 d-flex justify-content-between ' >
                <?php
                $c=-9; 
                    for($i=0;$i<9;$i++)
...
<!-- LINEA 10 -->
        <div class='row' style='background:#eee;border-radius:10px;margin-bottom:10px'>
            <label class='col-3' for="">Distancia a vías de acceso (ejemplo: carreteras y puertos)  </label>
            <div class='col-6 d-flex justify-content-between ' >
                <?php
                $c=-9; 
                    for($i=0;$i<9;$i++)
        ...
        <!-- <label id='' for="" class="text-primary" style=''>* Orientación cardinal de la pendiente del terreno (norte, este, sur, oeste, etc.)</label><br>
        ...
        <div class='d-flex justify-content-end mb-4'>
            ...
            <button id='btn-3' class=' btn btn-primary'>Siguiente</button>
        </div>
    </form>
</div>
